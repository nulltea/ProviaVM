...
impl<const XLEN: usize> LookupQuery<XLEN> for RISCVCycle<JALR> {
    ...
    fn to_instruction_inputs(&self) -> (u64, i128) {
        match XLEN {
            #[cfg(test)]
            8 => (self.register_state.rs1 as u8 as u64, self.instruction.operands.imm as u8 as u64 as i128),
            32 => (self.register_state.rs1 as u32 as u64, self.instruction.operands.imm as u32 as u64 as i128),
