use tracer::instruction::{virtual_assert_halfword_alignment::VirtualAssertHalfwordAlignment, RISCVCycle};
...
impl<const XLEN: usize> LookupQuery<XLEN> for RISCVCycle<VirtualAssertHalfwordAlignment> {
    ...
    fn to_lookup_output(&self) -> u64 {
        LookupQuery::<XLEN>::to_lookup_index(self).is_multiple_of(2).into()
    }
}
