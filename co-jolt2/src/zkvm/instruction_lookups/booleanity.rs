...
/// Uses the linearity of `gruen_evals_deg_3(q0, q_inf, prev)` in
/// `(q0, q_inf, previous_claim)` to lift the public Gruen coefficients into
/// shared/additive arithmetic.
        ...
        Self {
            ...
            state: BooleanityProverStateWorker {
                ...
                one_hot_e_fields: std::array::from_fn(|i| {
                    one_hot_polys[i].rand_ohv_e_field_bank.clone()
                }),
            ...
            if round == LOG_K_CHUNK - 1 {
                ...
                for i in 0..D {
                    let shifted_tables: Vec<Vec<Rep3PrimeFieldShare<F>>> = ps.one_hot_e_fields[i]
                        ...
                        .collect();
                    ps.H[i] = Rep3RaPolynomial::new_banked(
