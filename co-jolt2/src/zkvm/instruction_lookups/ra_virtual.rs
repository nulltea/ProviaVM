...
impl<F: JoltField> Rep3InstructionRaSumcheckWorker<F> {
    fn degree_inner(&self) -> usize {
        D + 1
    }

    fn num_rounds_inner(&self) -> usize {
        self.r_cycle.len()
    }
    ...
    fn bind_inner(&mut self, r_j: F::Challenge) {
        self.ra_i_polys
            .par_iter_mut()
    ...
    fn normalize_opening_point_inner(
        &self,
    ...
    fn cache_openings_worker_inner(
        &self,
