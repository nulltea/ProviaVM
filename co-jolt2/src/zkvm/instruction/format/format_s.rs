...
use tracer::instruction::format::format_s::FormatS;
...
/// Rep3 register state for S-format instructions (SD, SW, etc.)
/// No destination register — only rs1 and rs2.
#[derive(Default, Debug, Clone, Serialize, Deserialize, PartialEq)]
pub struct Rep3RegisterStateFormatS {
    pub rs1: Rep3Operand,
    pub rs2: Rep3Operand,
}

impl Rep3RegisterState for Rep3RegisterStateFormatS {
...
impl Rep3InstructionFormat for FormatS {
    type Rep3RegisterState = Rep3RegisterStateFormatS;
}
