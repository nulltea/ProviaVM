...
use tracer::instruction::format::format_load::FormatLoad;
...
/// Rep3 register state for Load-format instructions (LD, LW, etc.)
/// Same shape as FormatI: rd (old/new) + rs1.
#[derive(Default, Debug, Clone, Serialize, Deserialize, PartialEq)]
pub struct Rep3RegisterStateFormatLoad {
    pub rd: (Rep3Operand, Rep3Operand),
    pub rs1: Rep3Operand,
}

impl Rep3RegisterState for Rep3RegisterStateFormatLoad {
    ...
    fn populate_arithmetic<N: Rep3Network>(
        ...
        self.rd.0 = Rep3Operand::from_arithmetic(binary_shares[1], arithmetic_shares[1]);
        self.rd.1 = Rep3Operand::from_arithmetic(binary_shares[2], arithmetic_shares[2]);

        Ok(())
    }
}

impl Rep3InstructionFormat for FormatLoad {
    type Rep3RegisterState = Rep3RegisterStateFormatLoad;
}
